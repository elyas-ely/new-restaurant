...
//           className=" rounded-md p-1 flex justify-center items-center w-10 h-10"
...
//       </View>
//       <View className="p-4">
//         <Text className="text-xl mb-1 font-bold">
//           افغان رسټورانټ ته ښه راغلاست
//         </Text>
//         <Text className="text-l">ستاسو فرمایش زموږ کیفیت</Text>
//       </View>
...
//         </View>
//         <TouchableOpacity
//           className=" flex-row items-center p-3.5 rounded-lg  "
//           style={{ backgroundColor: themeColors.bgColor(1) }}
//         >
